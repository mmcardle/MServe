...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('jobservice_taskinput', (
        ...
        db.send_create_signal('jobservice', ['TaskInput'])

        # Adding model 'TaskResult'
        db.create_table('jobservice_taskresult', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('taskdescription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobservice.TaskDescription'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('jobservice', ['TaskResult'])

        # Adding model 'TaskOutput'
        db.create_table('jobservice_taskoutput', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mimetype', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('jobservice', ['TaskOutput'])

        # Adding model 'TaskOption'
        db.create_table('jobservice_taskoption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('taskdescription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobservice.TaskDescription'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('jobservice', ['TaskOption'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('jobservice_taskinput')

        # Deleting model 'TaskResult'
        db.delete_table('jobservice_taskresult')

        # Deleting model 'TaskOutput'
        db.delete_table('jobservice_taskoutput')

        # Deleting model 'TaskOption'
        db.delete_table('jobservice_taskoption')
