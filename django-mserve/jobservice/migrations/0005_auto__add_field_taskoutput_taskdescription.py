...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TaskOutput.taskdescription'
        db.add_column('jobservice_taskoutput', 'taskdescription', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='outputs', to=orm['jobservice.TaskDescription']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TaskOutput.taskdescription'
        db.delete_column('jobservice_taskoutput', 'taskdescription_id')
